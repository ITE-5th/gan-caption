...
generator = ConditionalGenerator(corpus=corpus, max_sentence_length=16, hidden_size=100).cuda()
...
image1 = image_folder + "image_1.pth"
image2 = image_folder + "image_2.pth"
image3 = image_folder + "image_3.pth"
image4 = image_folder + "image_4.pth"
image5 = image_folder + "image_5.pth"
image6 = image_folder + "image_6.pth"
